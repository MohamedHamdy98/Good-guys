...
import com.example.firebasetest.databinding.ActivityPeopleBinding;
...
public class PeopleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityPeopleBinding binding = DataBindingUtil.setContentView(this,R.layout.activity_people);
        binding.editTextPeopleUsername.getText().toString();
    ...
    private void getData() {
        FirebaseDatabase.getInstance().getReference().child("all information")
    ...
    private void map() {
        button_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("geo:29.2023709,31.182492?=15z"));
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(PeopleActivity.this,MapsActivity.class);
//                startActivity(intent);
//
//            }
//        });
    ...
    private void initialization() {
        editText_People_notes_about_sakan = findViewById(R.id.editText_People_notes_about_sakan);
        editText_number_of_help = findViewById(R.id.editText_People_number_of_help);
        editText_number_of_sons = findViewById(R.id.editText_People__number_son);
        editText_number_of_twabek = findViewById(R.id.editText_People_number_of_twabek);
        editText_number_of_hograt = findViewById(R.id.editText_People_number_of_hograt);
        editText_number_of_ghoraf = findViewById(R.id.editText_People_number_of_ghoraf);
        checkBox_flat = findViewById(R.id.checkbox_People_shaka);
        checkBox_ref = findViewById(R.id.checkbox_People_ref);
        checkBox_hadry = findViewById(R.id.checkbox_People_hadry);
        checkBox_esha = findViewById(R.id.checkbox_People_esha);
        checkBox_egarkadem = findViewById(R.id.checkbox_People_egarkadem);
        checkBox_egargded = findViewById(R.id.checkbox_People_egargded);
        checkBox_melk = findViewById(R.id.checkbox_People_melk);
        checkBox_dawla = findViewById(R.id.checkbox_People_dawla);
        checkBox_moshtarak = findViewById(R.id.checkbox_People_moshtarak);
        checkBox_ashway = findViewById(R.id.checkbox_People_ashway);
        checkBox_badw = findViewById(R.id.checkbox_People_badw);
        checkBox_ref_manteka = findViewById(R.id.checkbox_People_ref_manteka);
        checkBox_hadry_manteka = findViewById(R.id.checkbox_People_hadry_mateka);
        checkBox_mostakel = findViewById(R.id.checkbox_People_mostakel);
        checkBox_moshtarak_hammam = findViewById(R.id.checkbox_People_moshtarak_hammam);
        checkBox_mafesh = findViewById(R.id.checkbox_People_mafesh);
        checkBox_boos = findViewById(R.id.checkbox_People_boos);
        checkBox_khashap = findViewById(R.id.checkbox_People_khashap);
        checkBox_mafesh_sakf = findViewById(R.id.checkbox_People_mafesh_sakf);
        checkBox_kharasana = findViewById(R.id.checkbox_People_kharasana);
        editText_money_source_1 = findViewById(R.id.editText_People_money_source_1);
        editText_money_source_2 = findViewById(R.id.editText_People_money_source_2);
        editText_money_source_3 = findViewById(R.id.editText_People_money_source_3);
        editText_money_source_4 = findViewById(R.id.editText_People_money_source_4);
        editText_money_value_1 = findViewById(R.id.editText_People_money_value_1);
        editText_money_value_2 = findViewById(R.id.editText_People_money_value_2);
        editText_money_value_3 = findViewById(R.id.editText_People_money_value_3);
        editText_money_value_4 = findViewById(R.id.editText_People_money_value_4);
        editText_money_regulary_1 = findViewById(R.id.editText_People_money_regulary_1);
        editText_money_regulary_2 = findViewById(R.id.editText_People_money_regulary_2);
        editText_money_regulary_3 = findViewById(R.id.editText_People_money_regulary_3);
        editText_money_regulary_4 = findViewById(R.id.editText_People_money_regulary_4);
        editText_money_notes_1 = findViewById(R.id.editText_People_money_notes_1);
        editText_money_notes_2 = findViewById(R.id.editText_People_money_notes_2);
        editText_money_notes_3 = findViewById(R.id.editText_People_money_notes_3);
        editText_money_notes_4 = findViewById(R.id.editText_People_money_notes_4);
        editText_money_home = findViewById(R.id.editText_People_money_home);
        editText_money_dept = findViewById(R.id.editText_People_money_debt);
        editText_money_school = findViewById(R.id.editText_People_money_school);
        editText_money_water = findViewById(R.id.editText_People_money_water);
        editText_money_other = findViewById(R.id.editText_People_money_other);
        editText_money_medicine = findViewById(R.id.editText_People_money_medicine);
        editText_dateMarried_son_1 = findViewById(R.id.editText_People__date_married_son_1);
        editText_age_son_1 = findViewById(R.id.editText_People__age_son_1);
        editText_name_son_1 = findViewById(R.id.editText_People__name_son_1);
        editText_status_son_1 = findViewById(R.id.editText_People__status_son_1);
        editText_education_son_1 = findViewById(R.id.editText_People__education_son_1);
        editText_help_son_1 = findViewById(R.id.editText_People__help_son_1);
        editText_work_son_1 = findViewById(R.id.editText_People__work_son_1);
        editText_name_son_2 = findViewById(R.id.editText_People__name_son_2);
        editText_age_son_2 = findViewById(R.id.editText_People__age_son_2);
        editText_education_son_2 = findViewById(R.id.editText_People__education_son_2);
        editText_work_son_2 = findViewById(R.id.editText_People__work_son_2);
        editText_status_son_2 = findViewById(R.id.editText_People__status_son_2);
        editText_help_son_2 = findViewById(R.id.editText_People__help_son_2);
        editText_dateMarried_son_2 = findViewById(R.id.editText_People__date_married_son_2);
        editText_name_son_3 = findViewById(R.id.editText_People__name_son_3);
        editText_age_son_3 = findViewById(R.id.editText_People__age_son_3);
        editText_education_son_3 = findViewById(R.id.editText_People__education_son_3);
        editText_work_son_3 = findViewById(R.id.editText_People__work_son_3);
        editText_status_son_3 = findViewById(R.id.editText_People__status_son_3);
        editText_help_son_3 = findViewById(R.id.editText_People__help_son_3);
        editText_dateMarried_son_3 = findViewById(R.id.editText_People__date_married_son_3);
        editText_name_son_4 = findViewById(R.id.editText_People__name_son_4);
        editText_age_son_4 = findViewById(R.id.editText_People__age_son_4);
        editText_education_son_4 = findViewById(R.id.editText_People__education_son_4);
        editText_work_son_4 = findViewById(R.id.editText_People__work_son_4);
        editText_status_son_4 = findViewById(R.id.editText_People__status_son_4);
        editText_help_son_4 = findViewById(R.id.editText_People__help_son_4);
        editText_dateMarried_son_4 = findViewById(R.id.editText_People__date_married_son_4);
        editText_name_son_5 = findViewById(R.id.editText_People__name_son_5);
        editText_age_son_5 = findViewById(R.id.editText_People__age_son_5);
        editText_education_son_5 = findViewById(R.id.editText_People__education_son_5);
        editText_work_son_5 = findViewById(R.id.editText_People__work_son_5);
        editText_status_son_5 = findViewById(R.id.editText_People__status_son_5);
        editText_help_son_5 = findViewById(R.id.editText_People__help_son_5);
        editText_dateMarried_son_5 = findViewById(R.id.editText_People__date_married_son_5);
        editText_name_son_6 = findViewById(R.id.editText_People__name_son_6);
        editText_age_son_6 = findViewById(R.id.editText_People__age_son_6);
        editText_education_son_6 = findViewById(R.id.editText_People__education_son_6);
        editText_work_son_6 = findViewById(R.id.editText_People__work_son_6);
        editText_status_son_6 = findViewById(R.id.editText_People__status_son_6);
        editText_help_son_6 = findViewById(R.id.editText_People__help_son_6);
        editText_dateMarried_son_6 = findViewById(R.id.editText_People__date_married_son_6);
        editText_name_son_7 = findViewById(R.id.editText_People__name_son_7);
        editText_age_son_7 = findViewById(R.id.editText_People__age_son_7);
        editText_education_son_7 = findViewById(R.id.editText_People__education_son_7);
        editText_work_son_7 = findViewById(R.id.editText_People__work_son_7);
        editText_status_son_7 = findViewById(R.id.editText_People__status_son_7);
        editText_help_son_7 = findViewById(R.id.editText_People__help_son_7);
        editText_dateMarried_son_7 = findViewById(R.id.editText_People__date_married_son_7);
        editText_name_son_8 = findViewById(R.id.editText_People__name_son_8);
        editText_age_son_8 = findViewById(R.id.editText_People__age_son_8);
        editText_education_son_8 = findViewById(R.id.editText_People__education_son_8);
        editText_work_son_8 = findViewById(R.id.editText_People__work_son_8);
        editText_status_son_8 = findViewById(R.id.editText_People__status_son_8);
        editText_help_son_8 = findViewById(R.id.editText_People__help_son_8);
        editText_dateMarried_son_8 = findViewById(R.id.editText_People__date_married_son_8);
        editText_name_son_9 = findViewById(R.id.editText_People__name_son_9);
        editText_age_son_9 = findViewById(R.id.editText_People__age_son_9);
        editText_education_son_9 = findViewById(R.id.editText_People__education_son_9);
        editText_work_son_9 = findViewById(R.id.editText_People__work_son_9);
        editText_status_son_9 = findViewById(R.id.editText_People__status_son_9);
        editText_help_son_9 = findViewById(R.id.editText_People__help_son_9);
        editText_dateMarried_son_9 = findViewById(R.id.editText_People__date_married_son_9);
        editText_name_son_10 = findViewById(R.id.editText_People__name_son_10);
        editText_age_son_10 = findViewById(R.id.editText_People__age_son_10);
        editText_education_son_10 = findViewById(R.id.editText_People__education_son_10);
        editText_work_son_10 = findViewById(R.id.editText_People__work_son_10);
        editText_status_son_10 = findViewById(R.id.editText_People__status_son_10);
        editText_help_son_10 = findViewById(R.id.editText_People__help_son_10);
        editText_dateMarried_son_10 = findViewById(R.id.editText_People__date_married_son_10);
        button_map = findViewById(R.id.button_map);
        edit_huspand_name = findViewById(R.id.editText_People_name_zoog);
        edit_huspand_age = findViewById(R.id.editText_People_age_zoog);
        edit_huspand_work = findViewById(R.id.editText_People_work_zoog);
        edit_user_name = findViewById(R.id.editText_People_username);
        edit_user_social_status = findViewById(R.id.editText_People_social_status);
        edit_user_age = findViewById(R.id.editText_People_age);
        edit_user_address = findViewById(R.id.editText_People_address);
        edit_user_work = findViewById(R.id.editText_People_work);
        edit_user_phone = findViewById(R.id.editText_People_phone);
        edit_user_location_map = findViewById(R.id.editText_People_location);
        ...
        layout8 = findViewById(R.id.linear8);
        layout9 = findViewById(R.id.linear9);
        layout10 = findViewById(R.id.linear10);
        layout_money_1 = findViewById(R.id.linear_money_1);
        layout_money_2 = findViewById(R.id.linear_money_2);
        layout_money_3 = findViewById(R.id.linear_money_3);
        layout_money_4 = findViewById(R.id.linear_money_4);
        layout_money_5 = findViewById(R.id.linear_money_5);
        layout_money_6 = findViewById(R.id.linear_money_6);
        layout_help_1 = findViewById(R.id.linear_help_1);
        layout_help_2 = findViewById(R.id.linear_help_2);
        layout_help_3 = findViewById(R.id.linear_help_3);
        layout_help_4 = findViewById(R.id.linear_help_4);
...
//                String hadry = checkBox_hadry.getText().toString();
                ...
                if (!TextUtils.isEmpty(number_of_sons) || !TextUtils.isEmpty(age) || !TextUtils.isEmpty(phone) || !TextUtils.isEmpty(name) ||
                    ...
                    Toast.makeText(PeopleActivity.this, "تم إدخال البيانات", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(PeopleActivity.this, "لم يتم إدخال البيانات", Toast.LENGTH_SHORT).show();
                }
    ...
    public void onCheckboxClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.checkbox_People_shaka:


                break;
            case R.id.checkbox_People_esha:


                break;

            case R.id.checkbox_People_hadry:


                break;

            case R.id.checkbox_People_ref:

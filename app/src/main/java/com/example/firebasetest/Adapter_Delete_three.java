...
public class Adapter_Delete_three extends  RecyclerView.Adapter<Adapter_Delete_three.Adapter>{
    Context context;
    ArrayList<Module> arrayList;

    public Adapter_Delete_three(Context context, ArrayList<Module> arrayList) {
    ...
    @NonNull
    @Override
    public Adapter_Delete_three.Adapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.delete_layout,parent,false);
        Adapter_Delete_three.Adapter adapter = new Adapter_Delete_three.Adapter(view);
        return adapter;
    }

...
public class MyAdapter_tow extends RecyclerView.Adapter<MyAdapter_tow.Adapter>{
    Context context;
    ArrayList<Module> arrayList;

    public MyAdapter_tow(Context context, ArrayList<Module> arrayList) {
    ...
    public void onBindViewHolder(@NonNull Adapter holder, int position) {
        ...
        holder.btn_show_all_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context,type_of_show_data_tow_activity.class);

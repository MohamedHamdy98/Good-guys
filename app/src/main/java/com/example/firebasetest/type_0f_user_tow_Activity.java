...
public class type_0f_user_tow_Activity extends AppCompatActivity {
    ...
    CheckBox checkBox_flat, checkBox_ref, checkBox_hadry, checkBox_esha, checkBox_egarkadem, checkBox_egargded, checkBox_melk,
            ...
            checkBox_kharasana;
    DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("users_tow").push();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setTheme(R.style.ActionBar);
        setContentView(R.layout.activity_type_0f_user_tow_);
        initialization();
        item_spinner();
        insert_data();
    }
    ...
    private void initialization() {
        editText_People_notes_about_sakan = findViewById(R.id.editText_People_notes_about_sakan_insert_tow);
        editText_number_of_help = findViewById(R.id.editText_People_number_of_help_insert_tow);
        editText_number_of_sons = findViewById(R.id.editText_People__number_son_insert_tow);
        editText_number_of_twabek = findViewById(R.id.editText_People_number_of_twabek_insert_tow);
        editText_number_of_hograt = findViewById(R.id.editText_People_number_of_hograt_insert_tow);
        editText_number_of_ghoraf = findViewById(R.id.editText_People_number_of_ghoraf_insert_tow);
        checkBox_flat = findViewById(R.id.checkbox_People_shaka_insert_tow);
        checkBox_ref = findViewById(R.id.checkbox_People_ref_insert_tow);
        checkBox_hadry = findViewById(R.id.checkbox_People_hadry_insert_tow);
        checkBox_esha = findViewById(R.id.checkbox_People_esha_insert_tow);
        checkBox_egarkadem = findViewById(R.id.checkbox_People_egarkadem_insert_tow);
        checkBox_egargded = findViewById(R.id.checkbox_People_egargded_insert_tow);
        checkBox_melk = findViewById(R.id.checkbox_People_melk_insert_tow);
        checkBox_dawla = findViewById(R.id.checkbox_People_dawla_insert_tow);
        checkBox_moshtarak = findViewById(R.id.checkbox_People_moshtarak_insert_tow);
        checkBox_ashway = findViewById(R.id.checkbox_People_ashway_insert_tow);
        checkBox_badw = findViewById(R.id.checkbox_People_badw_insert_tow);
        checkBox_ref_manteka = findViewById(R.id.checkbox_People_ref_manteka_insert_tow);
        checkBox_hadry_manteka = findViewById(R.id.checkbox_People_hadry_mateka_insert_tow);
        checkBox_mostakel = findViewById(R.id.checkbox_People_mostakel_insert_tow);
        checkBox_moshtarak_hammam = findViewById(R.id.checkbox_People_moshtarak_hammam_insert_tow);
        checkBox_mafesh = findViewById(R.id.checkbox_People_mafesh_insert_tow);
        checkBox_boos = findViewById(R.id.checkbox_People_boos_insert_tow);
        checkBox_khashap = findViewById(R.id.checkbox_People_khashap_insert_tow);
        checkBox_mafesh_sakf = findViewById(R.id.checkbox_People_mafesh_sakf_insert_tow);
        checkBox_kharasana = findViewById(R.id.checkbox_People_kharasana_insert_tow);
        editText_money_source_1 = findViewById(R.id.editText_People_money_source_1_insert_tow);
        editText_money_source_2 = findViewById(R.id.editText_People_money_source_2_insert_tow);
        editText_money_source_3 = findViewById(R.id.editText_People_money_source_3_insert_tow);
        editText_money_source_4 = findViewById(R.id.editText_People_money_source_4_insert_tow);
        editText_money_value_1 = findViewById(R.id.editText_People_money_value_1_insert_tow);
        editText_money_value_2 = findViewById(R.id.editText_People_money_value_2_insert_tow);
        editText_money_value_3 = findViewById(R.id.editText_People_money_value_3_insert_tow);
        editText_money_value_4 = findViewById(R.id.editText_People_money_value_4_insert_tow);
        editText_money_regulary_1 = findViewById(R.id.editText_People_money_regulary_1_insert_tow);
        editText_money_regulary_2 = findViewById(R.id.editText_People_money_regulary_2_insert_tow);
        editText_money_regulary_3 = findViewById(R.id.editText_People_money_regulary_3_insert_tow);
        editText_money_regulary_4 = findViewById(R.id.editText_People_money_regulary_4_insert_tow);
        editText_money_notes_1 = findViewById(R.id.editText_People_money_notes_1_insert_tow);
        editText_money_notes_2 = findViewById(R.id.editText_People_money_notes_2_insert_tow);
        editText_money_notes_3 = findViewById(R.id.editText_People_money_notes_3_insert_tow);
        editText_money_notes_4 = findViewById(R.id.editText_People_money_notes_4_insert_tow);
        editText_money_home = findViewById(R.id.editText_People_money_home_insert_tow);
        editText_money_dept = findViewById(R.id.editText_People_money_debt_insert_tow);
        editText_money_school = findViewById(R.id.editText_People_money_school_insert_tow);
        editText_money_water = findViewById(R.id.editText_People_money_water_insert_tow);
        editText_money_other = findViewById(R.id.editText_People_money_other_insert_tow);
        editText_money_medicine = findViewById(R.id.editText_People_money_medicine_insert_tow);
        editText_dateMarried_son_1 = findViewById(R.id.editText_People__date_married_son_1_insert_tow);
        editText_age_son_1 = findViewById(R.id.editText_People__age_son_1_insert_tow);
        editText_name_son_1 = findViewById(R.id.editText_People__name_son_1_insert_tow);
        editText_status_son_1 = findViewById(R.id.editText_People__status_son_1_insert_tow);
        editText_education_son_1 = findViewById(R.id.editText_People__education_son_1_insert_tow);
        editText_help_son_1 = findViewById(R.id.editText_People__help_son_1_insert_tow);
        editText_work_son_1 = findViewById(R.id.editText_People__work_son_1_insert_tow);
        editText_name_son_2 = findViewById(R.id.editText_People__name_son_2_insert_tow);
        editText_age_son_2 = findViewById(R.id.editText_People__age_son_2_insert_tow);
        editText_education_son_2 = findViewById(R.id.editText_People__education_son_2_insert_tow);
        editText_work_son_2 = findViewById(R.id.editText_People__work_son_2_insert_tow);
        editText_status_son_2 = findViewById(R.id.editText_People__status_son_2_insert_tow);
        editText_help_son_2 = findViewById(R.id.editText_People__help_son_2_insert_tow);
        editText_dateMarried_son_2 = findViewById(R.id.editText_People__date_married_son_2_insert_tow);
        editText_name_son_3 = findViewById(R.id.editText_People__name_son_3_insert_tow);
        editText_age_son_3 = findViewById(R.id.editText_People__age_son_3_insert_tow);
        editText_education_son_3 = findViewById(R.id.editText_People__education_son_3_insert_tow);
        editText_work_son_3 = findViewById(R.id.editText_People__work_son_3_insert_tow);
        editText_status_son_3 = findViewById(R.id.editText_People__status_son_3_insert_tow);
        editText_help_son_3 = findViewById(R.id.editText_People__help_son_3_insert_tow);
        editText_dateMarried_son_3 = findViewById(R.id.editText_People__date_married_son_3_insert_tow);
        editText_name_son_4 = findViewById(R.id.editText_People__name_son_4_insert_tow);
        editText_age_son_4 = findViewById(R.id.editText_People__age_son_4_insert_tow);
        editText_education_son_4 = findViewById(R.id.editText_People__education_son_4_insert_tow);
        editText_work_son_4 = findViewById(R.id.editText_People__work_son_4_insert_tow);
        editText_status_son_4 = findViewById(R.id.editText_People__status_son_4_insert_tow);
        editText_help_son_4 = findViewById(R.id.editText_People__help_son_4_insert_tow);
        editText_dateMarried_son_4 = findViewById(R.id.editText_People__date_married_son_4_insert_tow);
        editText_name_son_5 = findViewById(R.id.editText_People__name_son_5_insert_tow);
        editText_age_son_5 = findViewById(R.id.editText_People__age_son_5_insert_tow);
        editText_education_son_5 = findViewById(R.id.editText_People__education_son_5_insert_tow);
        editText_work_son_5 = findViewById(R.id.editText_People__work_son_5_insert_tow);
        editText_status_son_5 = findViewById(R.id.editText_People__status_son_5_insert_tow);
        editText_help_son_5 = findViewById(R.id.editText_People__help_son_5_insert_tow);
        editText_dateMarried_son_5 = findViewById(R.id.editText_People__date_married_son_5_insert_tow);
        editText_name_son_6 = findViewById(R.id.editText_People__name_son_6_insert_tow);
        editText_age_son_6 = findViewById(R.id.editText_People__age_son_6_insert_tow);
        editText_education_son_6 = findViewById(R.id.editText_People__education_son_6_insert_tow);
        editText_work_son_6 = findViewById(R.id.editText_People__work_son_6_insert_tow);
        editText_status_son_6 = findViewById(R.id.editText_People__status_son_6_insert_tow);
        editText_help_son_6 = findViewById(R.id.editText_People__help_son_6_insert_tow);
        editText_dateMarried_son_6 = findViewById(R.id.editText_People__date_married_son_6_insert_tow);
        editText_name_son_7 = findViewById(R.id.editText_People__name_son_7_insert_tow);
        editText_age_son_7 = findViewById(R.id.editText_People__age_son_7_insert_tow);
        editText_education_son_7 = findViewById(R.id.editText_People__education_son_7_insert_tow);
        editText_work_son_7 = findViewById(R.id.editText_People__work_son_7_insert_tow);
        editText_status_son_7 = findViewById(R.id.editText_People__status_son_7_insert_tow);
        editText_help_son_7 = findViewById(R.id.editText_People__help_son_7_insert_tow);
        editText_dateMarried_son_7 = findViewById(R.id.editText_People__date_married_son_7_insert_tow);
        editText_name_son_8 = findViewById(R.id.editText_People__name_son_8_insert_tow);
        editText_age_son_8 = findViewById(R.id.editText_People__age_son_8_insert_tow);
        editText_education_son_8 = findViewById(R.id.editText_People__education_son_8_insert_tow);
        editText_work_son_8 = findViewById(R.id.editText_People__work_son_8_insert_tow);
        editText_status_son_8 = findViewById(R.id.editText_People__status_son_8_insert_tow);
        editText_help_son_8 = findViewById(R.id.editText_People__help_son_8_insert_tow);
        editText_dateMarried_son_8 = findViewById(R.id.editText_People__date_married_son_8_insert_tow);
        editText_name_son_9 = findViewById(R.id.editText_People__name_son_9_insert_tow);
        editText_age_son_9 = findViewById(R.id.editText_People__age_son_9_insert_tow);
        editText_education_son_9 = findViewById(R.id.editText_People__education_son_9_insert_tow);
        editText_work_son_9 = findViewById(R.id.editText_People__work_son_9_insert_tow);
        editText_status_son_9 = findViewById(R.id.editText_People__status_son_9_insert_tow);
        editText_help_son_9 = findViewById(R.id.editText_People__help_son_9_insert_tow);
        editText_dateMarried_son_9 = findViewById(R.id.editText_People__date_married_son_9_insert_tow);
        editText_name_son_10 = findViewById(R.id.editText_People__name_son_10_insert_tow);
        editText_age_son_10 = findViewById(R.id.editText_People__age_son_10_insert_tow);
        editText_education_son_10 = findViewById(R.id.editText_People__education_son_10_insert_tow);
        editText_work_son_10 = findViewById(R.id.editText_People__work_son_10_insert_tow);
        editText_status_son_10 = findViewById(R.id.editText_People__status_son_10_insert_tow);
        editText_help_son_10 = findViewById(R.id.editText_People__help_son_10_insert_tow);
        editText_dateMarried_son_10 = findViewById(R.id.editText_People__date_married_son_10_insert_tow);
        button_map = findViewById(R.id.button_map_insert_tow);
        edit_huspand_name = findViewById(R.id.editText_People_name_zoog_insert_tow);
        edit_huspand_age = findViewById(R.id.editText_People_age_zoog_insert_tow);
        edit_huspand_work = findViewById(R.id.editText_People_work_zoog_insert_tow);
        edit_user_name = findViewById(R.id.editText_People_username_insert_tow);
        edit_user_social_status = findViewById(R.id.editText_People_social_status_insert_tow);
        edit_user_age = findViewById(R.id.editText_People_age_insert_tow);
        edit_user_address = findViewById(R.id.editText_People_address_insert_tow);
        edit_user_work = findViewById(R.id.editText_People_work_insert_tow);
        edit_user_phone = findViewById(R.id.editText_People_phone_insert_tow);
        edit_user_location_map = findViewById(R.id.editText_People_location_insert_tow);
        spinner = findViewById(R.id.spinner_insert_tow);
        spinner3 = findViewById(R.id.spinner3_insert_tow);
        layout1 = findViewById(R.id.linear1_insert_tow);
        layout2 = findViewById(R.id.linear2_insert_tow);
        layout3 = findViewById(R.id.linear3_insert_tow);
        layout4 = findViewById(R.id.linear4_insert_tow);
        layout5 = findViewById(R.id.linear5_insert_tow);
        layout6 = findViewById(R.id.linear6_insert_tow);
        layout7 = findViewById(R.id.linear7_insert_tow);
        layout8 = findViewById(R.id.linear8_insert_tow);
        layout9 = findViewById(R.id.linear9_insert_tow);
        layout10 = findViewById(R.id.linear10_insert_tow);
        layout_money_1 = findViewById(R.id.linear_money_1_insert_tow);
        layout_money_2 = findViewById(R.id.linear_money_2_insert_tow);
        layout_money_3 = findViewById(R.id.linear_money_3_insert_tow);
        layout_money_4 = findViewById(R.id.linear_money_4_insert_tow);
        layout_money_5 = findViewById(R.id.linear_money_5_insert_tow);
        layout_money_6 = findViewById(R.id.linear_money_6_insert_tow);
        layout_help_1 = findViewById(R.id.linear_help_1_insert_tow);
        layout_help_2 = findViewById(R.id.linear_help_2_insert_tow);
        layout_help_3 = findViewById(R.id.linear_help_3_insert_tow);
        layout_help_4 = findViewById(R.id.linear_help_4_insert_tow);
        btn_save = findViewById(R.id.button_save_insert_tow);
    }
    ...
    private void item_spinner() {
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(type_0f_user_tow_Activity.this, "Error!", Toast.LENGTH_SHORT).show();
            }
        });
...
//                String hadry = checkBox_hadry.getText().toString();
                ...
                if (!TextUtils.isEmpty(number_of_sons) || !TextUtils.isEmpty(age) || !TextUtils.isEmpty(phone) || !TextUtils.isEmpty(name) ||
                    ...
                    Toast.makeText(type_0f_user_tow_Activity.this, "تم إدخال البيانات", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(type_0f_user_tow_Activity.this, "لم يتم إدخال البيانات", Toast.LENGTH_SHORT).show();
                }

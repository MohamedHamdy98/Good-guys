...
public class Adapter_Delete extends  RecyclerView.Adapter<Adapter_Delete.Adapter> {
    Context context;
    ArrayList<Module> arrayList;

    public Adapter_Delete(Context context, ArrayList<Module> arrayList) {
    ...
    @NonNull
    @Override
    public Adapter_Delete.Adapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.delete_layout,parent,false);
        Adapter_Delete.Adapter adapter = new Adapter_Delete.Adapter(view);
        return adapter;
    }
    ...
    public void onBindViewHolder(@NonNull final Adapter holder, int position) {
        ...
        holder.button_delete_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("users_one");
